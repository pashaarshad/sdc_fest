            ...
            <div className="container-main py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-sm text-zinc-500 leading-relaxed max-w-xs">
                            The biggest inter-college fest bringing together talent from across the region.
                        </p>
                    </div>
                    ...
                    <div id="contact">
                        ...
                        <ul className="space-y-3 text-sm text-zinc-500">
                            <li className="flex items-start gap-2">
                                <svg className="w-4 h-4 mt-0.5 text-zinc-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <span>Shesha College, Mysore, Karnataka</span>
                            </li>
                            <li>
                                <a href="mailto:sdcfest@shesha.edu.in" className="flex items-center gap-2 hover:text-white transition-colors">
                                    <svg className="w-4 h-4 text-zinc-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <span>sdcfest@shesha.edu.in</span>
                                </a>
                            </li>
                            <li>
                ...
                <div className="border-t border-white/5 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-xs text-zinc-600">
                        © {currentYear} SDC Fest, Shesha College Mysore. All rights reserved.
                    </p>
                    <div className="flex items-center gap-4">
                        ...
                        <a href="#" className="text-zinc-600 hover:text-white transition-colors" aria-label="Instagram">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" className="text-zinc-600 hover:text-white transition-colors" aria-label="LinkedIn">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
