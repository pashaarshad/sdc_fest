                        ...
                        <div className="card-static p-6 md:p-8 sticky top-24 bg-[#18181c] border-white/10 shadow-xl shadow-black/50">
                            ...
                            <div className="space-y-6 mb-8">
                                {[
                                    ...
                                    ...(event.maxTeamsPerCollege ? [{ icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4", label: "Limit", value: event.maxTeamsPerCollege }] : []),
